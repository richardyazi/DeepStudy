...
def get_patch(input_array,idx_i,idx_j,kernel_width,kernel_height,stride):
    '''
    获得输出(i,j)对应的输入数组
    :param input_array:输入数组
    :param i: 输出对应的行号
    ...
    :return:
    '''
    start_i = idx_i * stride
    start_j = idx_j * stride
    ...
    if input_array.ndim == 3 :
        ...
        return input_array[start_i:start_i + kernel_height,
               start_j:start_j + kernel_width]
